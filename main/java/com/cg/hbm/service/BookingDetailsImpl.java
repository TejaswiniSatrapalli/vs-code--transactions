...
//	@Override
//	public List<BookingDetails> getBookingByName(String name){
//		return bookingRepo.getBookingByName(name);
//	}
	...
	public List<BookingDetails> getBookingByBookingId(int bookingId) 
	{ 
